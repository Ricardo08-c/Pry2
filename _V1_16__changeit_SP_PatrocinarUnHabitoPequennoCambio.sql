...
BEGIN	
	...
	BEGIN TRY
		...
		,@ComputerName,@Date,@TypeTraId,@SubTypeTraId,@UserId,@Destina,@PayUS,@Description,@IPaddres,@PaymentAtt)
		...
		INSERT INTO Transactions VALUES
		(CHECKSUM(@ComputerName,@Date,@TypeTraId,@SubTypeTraId,@UserId,@Destina,@Amount,@Description,@IPaddres)
		,@ComputerName,@Date,@TypeTraId,@SubTypeTraId,@UserId,@Destina,@PayADS,@Description,@IPaddres,@PaymentAtt)
