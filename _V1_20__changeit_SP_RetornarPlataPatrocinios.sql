...
BEGIN	
	...
	BEGIN TRY
		...
		SET @Date = CAST(CONCAT(YEAR(GETDATE()),'-',@Mes+1,'-01') AS DATETIME)
...
EXEC [changeit_SP_RetornarPlataPatrocinios] 7
...
DBCC CHECKIDENT ('PaymentAttempts', RESEED, 0)

DECLARE @Date DATETIME
SET @Date = GETDATE()
EXEC [changeit_SP_PatrocinarUnHabito] 'Disminucion de plastico10','Juan0',10000,@Date
